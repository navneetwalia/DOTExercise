DOT Exercise Automaton Framework is a C# framework which automates the manual testing of UI. It uses the following frameworks and libraries and is built on the latest .NET platform.
